...
<div class="box">
    ...
    <p>
        I am also a musician with <strong class="strong-accent">17</strong> years of experience playing guitar, bass, and synths. I started playing guitar at <strong class="strong-accent">6</strong>, bass at somewhere around <strong class="strong-accent">10</strong> years old, and keyboards/synthesis at around <strong class="strong-accent">12</strong> years old. While I tend to produce music in the <em>Drum n' Bass</em> and <em>Jungle</em> genres, I have made projects for pretty much any genre under the sun. I enjoy listening to different genres depending on my mood, typically Jazz, Drum n' Bass, Metal, or Rap, although I also have playlists for Blues/Bluegrass/Folk, Ambient, and other genres I like; they're for more niche moods.
    </p>
</div>
    ...
    <ul class="p language-grid">
        <li class="biglist lang-list">
            <div>
                ...
                <p class="single_line lang_body">
                    My first programming language learned. Little uptu thought that Java was going to overtake C/C++ because of that sweet sweet JVM.
                    <br>
                    <br>
        ...
        <li class="biglist lang-list">
            <div>
                ...
                <p class="single_line lang_body">
                    I'm currently using Rust as my daily driver, as it provides some nifty low-level support, and polling has shown that most programmers love Rust more than their own mothers. Currently, I'm developing games using the <a href="https://bevyengine.org/">Bevy</a> framework.
                </p>
            </div>
        </li>
        <br>
        <li class="biglist lang-list">
            <div>
                ...
                <p class="lang_body">                                        
                    I learned CSS primarily to modify a stylesheet on a subreddit I moderated, which I was migrating to use Naut with some tweaks.<br>I have less experience with JavaScript, although I have been actively learning TypeScript recently to code this website, primarily using Svelte as a framework.
                </p>
            </div>
        </li>
        <br>
        ...
        <li class="biglist lang-list">
            <div>
                ...
                <p class="single_line lang_body">
                    Taught me how much I took curly-brace syntax for granted with other languages! I have a love-hate relationship with the language, as although the lack of braces makes scripting easier and faster in it, I find myself making indentation errors often that become crippling where they wouldn't be in other languages. I prefer my scripts in Lua or TypeScript, personally.
                </p>
            </div>
        </li>
        <br>
        ...
        <li class="biglist lang-list">
            <div>
                ...
                <p class="single_line lang_body">
                    I originally wanted to learn C++ as my next language after learning TypeScript, however, Rust seems to pretty much be the successor to C++. As such, I looked into the spiritual successor to C, Zig. I am currently in the process of learning it, but given it works as a drop-in C compiler, it hasn't been a difficult process.
                </p>
            </div>
        </li>
    </ul>
...
<div class="box">
    ...
    <p>
        I recently decided to make a portfolio website to showcase my web dev skills (and host WASM verisons of games I make), with the decision between using <a href="https://yew.rs/">Yew</a>, <a href="https://vuejs.org/">Vue.js 3</a>, and <a href="https://react.dev/">React</a> being more difficult than expected. At the end of the day, I ended up using React, with the prototype of my website having been originally written in Vue.js (and thus requiring rewriting).
